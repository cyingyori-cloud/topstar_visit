...
// A级(6家): 每月联系、季度上门, 超期90天, 商机中(20~60万)
// B级(10家): 月度联系≥1次, 超期30天, 商机小(8~25万)
// C级(10家): 系统自动标记、销售自主激活, 超期180天, 商机极小(3~10万)
...
export const customers: Customer[] = [
  // === S级 · 战略客户（4家）===
  {
    ...
    currentOpportunity: '注塑取件机器人工作站',
    opportunityAmount: 120,
    opportunityStage: '“报”价值',
    opportunityPercent: 80,
    opportunityDescription: '节拍数据已获制造部认可，当前需把技术认可转化为方案评审和价值确认',
  },
  {
    id: 'c2',
    name: '富士康科技',
    ...
    opportunityDescription: '技术方案已通过评审，当前卡点在价格区间和正式采购流程启动',
  },
  {
    id: 'c3',
    name: '立讯精密',
  ...
  },
  {
    ...
    opportunityStage: '“获”商机',
    opportunityPercent: 30,
    opportunityDescription: '已确认5台CNC上下料需求，技术参数尚未闭环，客户已表达技术评审意愿',
  },
  {
    id: 'c7',
    name: '欣旺达',
    ...
    opportunityStage: '“报”价值',
    opportunityPercent: 80,
    opportunityDescription: '方案已提交客户内部评审，当前要跟进评审结果并补齐ROI材料',
  },
  {
    id: 'c11',
    name: 'TCL华星',
    ...
    opportunityStage: '“获”商机',
    opportunityPercent: 30,
    opportunityDescription: '客户已表达模组搬运自动化兴趣，需补齐节拍、工位边界和评审参与人',
  },
  {
    id: 'c12',
    name: '大族激光',
    ...
    opportunityStage: '“报”价值',
    opportunityPercent: 80,
    opportunityDescription: '技术方案已获认可，下一步进入报价、商务评估和价值证明',
  },
  {
    id: 'c13',
    name: '深天马',
  ...
  // === B级 · 活跃客户（10家）===
  {
    ...
    opportunityStage: '“查”信息',
    opportunityPercent: 10,
    opportunityDescription: '电话接触已表达PACK线自动化兴趣，现场信息和关键联系人仍需确认',
  },
  {
    id: 'c8',
    name: '木林森照明',
  ...
  },
  {
    ...
    opportunityStage: '休眠',
    opportunityPercent: 0,
    opportunityDescription: '客户反馈模组检测需求暂缓，当前只保留季度回访线索',
  },
  {
    id: 'c16',
    name: '蓝思科技',
    ...
    opportunityStage: '“获”商机',
    opportunityPercent: 30,
    opportunityDescription: '客户已提供部分技术参数，但夹具、节拍和良率边界尚未完整闭环',
  },
  {
    id: 'c17',
    name: '伯恩光学',
    ...
    opportunityStage: '“获”商机',
    opportunityPercent: 30,
    opportunityDescription: '现场拜访已识别5台设备需求，下一步需出具初步方案并验证投入节奏',
  },
  {
    id: 'c18',
    name: '领益智造',
  ...
  },
  {
    ...
    opportunityStage: '“收”线索',
    opportunityPercent: 0,
    opportunityDescription: '客户项目排期延后至Q3，当前保留线索并等待重新启动信号',
  },
  {
    id: 'c20',
    name: '合力泰',
    ...
    opportunityStage: '“收”线索',
    opportunityPercent: 0,
    opportunityDescription: '贴片自动化需求仍待定，当前适合季度回访和关系维护',
  },
  {
    id: 'c20b',
    name: '江门市江科泰电子有限公司',
...
export const visitTasks: VisitTask[] = [
  ...
  },
  {
    id: 't4',
    customerId: 'c20b',
    customerName: '江门市江科泰电子有限公司',
    customerLevel: 'A',
    confirmationStatus: 'pending_confirmation',
    visitType: '客情回访',
    visitPurpose: '江科泰三机一体除湿方案客情推进',
    visitTime: '15:30',
    location: '江门市江海区江科泰工业园',
    status: 'pending',
    contacts: [
      { name: '陈总', title: '生产总监', phone: '138****2001' },
      { name: '林工', title: '设备主管', phone: '139****2002' },
    ...
    lastVisitSummary: '初步交流新产品除湿要求，客户关注设备稳定性和节拍匹配',
    dayLabel: '明天',
    visitGoal: '江科泰新产品除湿要求较高，当前商机处于“做”客情阶段，需要发展内线并摸清决策链。',
    expectedCommitment: '确认除湿指标、设备约束和下一次技术交流参与人。',
    opportunityIntent: 'with_opportunity',
    opportunityTopic: '江科泰＋三机一体＋1',
    opportunityRisk: '除湿要求高，方案参数和决策链仍需补齐',
    healthScore: 72,
    healthTrend: 'up',
    visitFocus: '围绕江科泰三机一体商机，补齐除湿工艺要求、设备边界和关键联系人态度。',
  },
  {
    id: 't4a',
    customerId: 'c9',
